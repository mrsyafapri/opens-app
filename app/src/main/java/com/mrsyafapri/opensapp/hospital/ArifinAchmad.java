...
public class ArifinAchmad extends ListActivity {
    ...
    private void showPilihan(String pilihan) {
        try {
            ...
            if ("Call Center".equals(pilihan)) {
                ...
                String location = "https://maps.app.goo.gl/p25DazP86RVvaY626";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(location));
            } else if ("Website".equals(pilihan)) {
                String website = "https://rsudarifinachmad.riau.go.id/";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));
            } else if ("Info Google".equals(pilihan)) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Rumah Sakit Umum Daerah Arifin Achmad Pekanbaru");
            }
            startActivity(a);
        } catch (Exception e) {
            e.printStackTrace();
